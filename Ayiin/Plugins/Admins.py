...
from Ayiin.Core.PyTgCalls.Ayiin import (pause_stream, resume_stream,
                                        skip_stream, skip_video_stream,
                                        stop_stream)
from Ayiin.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat,
                            remove_active_video_chat)
from Ayiin.Decorators.admins import AdminRightsCheck
from Ayiin.Decorators.checker import checker, checkerCB
from Ayiin.Inline import audio_markup, primary_markup, secondary_markup2
